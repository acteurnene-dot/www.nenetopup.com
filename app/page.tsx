  ...
  return (
    <div className="storefront">
      ...
      <main id="top" className="container">
        ...
        <section className="promo-video-section" aria-labelledby="promo-video-title"><div className="section-heading"><span className="section-kicker">VIDEO</span><h2 id="promo-video-title">Cuban Proxy</h2></div><div className="promo-video-frame"><video className="promo-video" autoPlay muted loop playsInline preload="auto" aria-label="Videyo prezantasyon Cuban Proxy"><source src="/cuban-proxy-promo.mp4" type="video/mp4" />Navigatè ou pa sipòte videyo sa a.</video></div></section>
