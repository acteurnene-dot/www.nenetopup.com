...
type Product = { name: string; duration: string; price: number; type: 'android' | 'iphone' | 'free-fire' | 'cuban-proxy' }
...
export default function Page() {
  ...
  const [activeType, setActiveType] = useState<'android' | 'iphone' | 'free-fire' | 'cuban-proxy' | null>(null)
  ...
  function showPlans(type: 'android' | 'iphone' | 'free-fire' | 'cuban-proxy') {
    setActiveType(type)
  ...
  return (
    <div className="storefront">
      ...
      <main id="top" className="container">
        ...
        <section className="promo-video-section" aria-labelledby="promo-video-title"><div className="section-heading"><span className="section-kicker">VIDEO</span><h2 id="promo-video-title">Proxy</h2></div><div className="promo-video-frame"><video ref={promoVideoRef} className="promo-video" autoPlay loop playsInline preload="auto" aria-label="Videyo prezantasyon Proxy"><source src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/VID-20260804-WA0394-TrQODewsZxlrUtkU9HYYqsFeY95chE.mp4" type="video/mp4" />Navigatè ou pa sipòte videyo sa a.</video><button className="video-sound-button" type="button" onClick={enablePromoSound} aria-label="Aktive son videyo a">Aktive son</button></div></section>
